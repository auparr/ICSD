...
// BUG FIX: "use client" removed — zero interactivity here, runs as Server Component
// This eliminates the JS bundle for this component entirely
    ...
    <section className="bg-[#E8F5E9] py-16 md:py-24">
      <div className="container mx-auto px-4 max-w-4xl text-center">
        ...
        <Button
          asChild
          size="lg"
          className="bg-[#5BAA6A] hover:bg-[#4a9159] text-white rounded-full px-12 md:px-16 py-8 md:py-9 text-xl md:text-2xl font-extrabold shadow-2xl hover:shadow-3xl transition-all scale-100 hover:scale-[1.03] active:scale-[0.98] w-full sm:w-auto"
        >
          <Link
            href="#daftar"
