...
export function FAQSection() {
  // BUG FIX: removed unused `useState` import — this component has no local state
  return (
      ...
      <div className="container mx-auto px-4 max-w-5xl">
        ...
        >
          {FAQS.map((faq) => (
            ...
            >
              <AccordionTrigger className="text-left font-semibold text-[#2E2E2E] hover:text-[#5BAA6A] transition-colors hover:no-underline">
                {faq.question}
              </AccordionTrigger>
        ...
        <div className="mt-16 text-center">
          ...
          {/* BUG FIX: "shadowhover:shadow-xl" was a typo — missing space, shadow never applied */}
          <Button
            asChild
            className="bg-transparent border border-[#5BAA6A] text-[#5BAA6A] hover:bg-[#5BAA6A] hover:text-white rounded px-12 md:px-16 py-6 md:py-7 text-xl md:text-2xl font-extrabold shadow hover:shadow-xl transition-all duration-300 scale-100 hover:scale-[1.03] active:scale-[0.98] w-full sm:w-auto"
          >
            <Link
              href="#kontak"
